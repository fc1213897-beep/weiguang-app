  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <h3 className="mb-3 text-sm font-semibold text-stone-700">学习数据</h3>
      ...
      {isAuthenticated && (
        ...
        <section>
          ...
          <h3 className="mb-3 text-sm font-semibold text-stone-700">记账</h3>
          ...
          <div className="space-y-4">
            ...
            <ExpenseRecentList
              ...
              expenses={expenseStats.recentExpenses.slice(0, 8)}
